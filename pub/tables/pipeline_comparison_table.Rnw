...
<< lm_vcf_table_1, results=tex,echo=FALSE>>=
...
<< lm_vcf_table_2, results=tex,echo=FALSE>>=
...
<< lm_vcf_table_3, results=tex,echo=FALSE>>=
...
<< lm_vcf_table_4, results=tex,echo=FALSE>>=
...
<< lm_vcf_table_5, results=tex,echo=FALSE>>=
...
<< lm_vcf_table_6, results=tex,echo=FALSE>>=
