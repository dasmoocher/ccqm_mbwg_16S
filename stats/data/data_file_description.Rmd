...
mbr_descript_print <- print.xtable(mbr_descript_table, type = "html")
```
...
bt_descript_print <- print.xtable(bt_descript_table, type = "html")
```
...
string_stats_descript_print <- print.xtable(string_stats_descript_table, type = "html")
```

```{r results='asis', echo=FALSE}
string_stats_descript_print
```
...
string_tables_descript_print <- print.xtable(string_tables_descript_table, type = "html")
```

```{r results='asis', echo=FALSE}
string_tables_descript_print
```
